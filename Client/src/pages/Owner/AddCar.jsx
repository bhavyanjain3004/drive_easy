...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
        <Title title="Add New Car" subTitle="Fill in details to list new car for
        booking, including pricing, avilability, and car specifications."/>
        ...
        text-sm mt-6 max-w-xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='flex flex-col w-full'>
              ...
              className='px-3 py-2 mt-1 border border-gray-200 rounded-md outline-none'
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            <div className='flex flex-col w-full'>
              ...
              <select onChange={e=> setCar({...car, transmission: e.target.value})} 
                value={car.transmission} className='px-3 py-2 mt-1 border border-gray-300 rounded-md outline-none'>
          ...
          <div className='flex flex-col w-full'>
            ...
            required className='px-3 py-2 mt-1 border border-gray-300 rounded-md outline-none' 
