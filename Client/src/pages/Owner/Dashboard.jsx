...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
        <Title title="Admin Dashboard" subTitle="Monitor overall platform performace including total cars, 
        ...
        <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
                ...
                {data.recentBookings.map((booking, index)=> (
                    <div key={index} className='mt-4 flex items-center justify-between'>
                        <div className='flex items-center gap-2'>
                            <div className='hidden md:flex items-center w-12 h-12 rounded-full bg-primary/10'>
                                <img src={assets.listIconColored} alt="" className='h-5 w-12'/>
                            </div>
                            <div>
                        ...
                        <div className='flex items-center gap-2 font-medium'>
                            ...
                            <p className='px-3 py-0.5 border border-gray-300 rounded-full text-sm'>{booking.status}</p>
                        </div>
                    </div>
                ))}
            </div>
            ...
            {/* Monthly Revenue */}
            <div className='p-4 md:p-6 mb-6 border border-gray-300 rounded-md w-full md:max-w-xs'>
...
//     useEffect(()=> {setData(dummyDashboardData)
